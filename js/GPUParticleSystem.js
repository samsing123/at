...
THREE.GPUParticleSystem = function(options) {
	...
	this.reverseAllParticleToStart = function(){
		for (var i = 0; i < self.PARTICLE_CONTAINERS; i++) {
			console.log(self.particleContainers[i]);
			self.particleContainers[i].velocity.x *= -1;
			self.particleContainers[i].velocity.y *= -1;
			self.particleContainers[i].velocity.z *= -1;
		}
	};
